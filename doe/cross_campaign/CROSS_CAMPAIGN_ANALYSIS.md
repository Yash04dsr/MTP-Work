...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| case_08 | 0.382 | 0.69 | 0.092 | 0.707 | 0.327 | -54% | 7.8 | 16.9 | +115% |
| case_10 | 0.396 | 0.81 | 0.112 | 0.407 | 0.345 | -15% | 4.2 | 2.9 | -32% |
| case_09 | 0.396 | 0.95 | 0.130 | 0.390 | 0.307 | -21% | 17.8 | 6.7 | -62% |
| case_07 | 0.382 | 1.14 | 0.142 | 0.440 | 0.238 | -46% | 32.5 | 11.6 | -64% |
| case_05 | 0.296 | 1.24 | 0.098 | 0.577 | 0.298 | -48% | 27.1 | 19.3 | -29% |
| case_03 | 0.252 | 1.33 | 0.078 | 0.472 | 0.278 | -41% | 28.6 | 26.7 | -7% |
| case_06 | 0.296 | 2.61 | 0.187 | 0.202 | 0.088 | -56% | 19.3 | 13.6 | -29% |

**The 30 deg branch wins on mixing in 7/7 pairs and on pumping cost in 6/7 pairs.**  Median improvements (30 vs 90):

  * CoV reduced by **46 %**
  * \|dP_rgh\| reduced by **29 %**
...
2. **30 deg also costs less to pump** in 6 of 7 pairs (median \|dP\| reduction ~ 29 %), because the tilted branch has a smaller turning loss.  The junction loss coefficient K = \|dP\|/q_dyn drops uniformly with the angle.
