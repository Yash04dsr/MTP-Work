...
TOKENS = [
    ...
    # 60deg fork: tilted-branch direction tokens
...
# --- 60deg fork: tilted-branch configuration -----------------------
...
def _make_env(case_dir: Path, row: dict) -> None:
    env = (
        ...
        f"\n"
        f"# 60deg fork: branch tilt parameter (read by generateSTL.py)\n"
