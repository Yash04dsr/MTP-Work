...
METRIC_ALIASES = {
    "CoV_area":        ("CoV_area", "CoV_A", "cov_area"),
    "CoV_massFlux":    ("CoV_massFlux", "CoV_mdot", "CoV_m", "cov_mass"),
    "CoV_volumeFlux":  ("CoV_volumeFlux", "CoV_vol", "CoV_V", "cov_vol"),
    "Is":              ("Is", "danckwerts_Is", "intensity_of_segregation"),
    "dP_static":       ("dP_static", "dP_pstatic", "dp_static"),
    "dP_total":        ("dP_total", "dp_total"),
    "dP_gauge":        ("dP_gauge", "dp_gauge"),
}
