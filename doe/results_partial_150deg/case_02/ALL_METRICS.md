...
|---|---:|---:|---:|---:|
| area | 0.00906 | 0.00232 | 0.2559 | 0.0006 |
| mass | 0.00888 | 0.00227 | 0.2559 | 0.0006 |
| vol  | 0.00892 | 0.00227 | 0.2547 | 0.0006 |
...
- ⟨Y_H₂⟩_area, time-series: **0.00802** (n = 213 samples in [0.802, 1.199] s)

## 2. Pressure drop

### 2a. Clean reference from function-object time series (area-weighted, every timestep)

- ΔP_area_ts on `p_rgh`: **3.551 kPa**  (⟨p_rgh⟩_inlet = 6903.6 kPa, ⟨p_rgh⟩_outlet = 6900.0 kPa, n = 213 samples)
...
|---|---:|---:|---:|
| static `p` | -33.876 | -33.876 | -33.876 |
| gauge `p_rgh` | -33.875 | -33.870 | -33.871 |
| total `p + ½ρU²` | -34.537 | -34.537 | -34.533 |
| gauge-total `p_rgh + ½ρU²` | -34.536 | -34.532 | -34.528 |

## 3. Mass balance

### 3a. Clean reference from outletFlux function object (every timestep)

- ⟨sum(phi)⟩_outlet (ṁ_out, kg/s), time-averaged: **+35.4056**  (σ = 8.8780, n = 213 samples, t ∈ [0.802, 1.199] s)

### 3b. From 3 snapshots (instantaneous, dominated by acoustic pulses)

- ṁ main_inlet  : **-33.4829** kg/s
- ṁ branch_inlet: **-0.2873** kg/s
- ṁ outlet      : **+38.1832** kg/s
- closure error : **+4.4130e+00 kg/s**  (+11.56 % of ṁ_outlet)

## 4. Per-snapshot detail

| time | CoV_area | CoV_mass | CoV_vol | ΔP_static_mass [kPa] | ΔP_total_mass [kPa] | balance [%] |
|---|---:|---:|---:|---:|---:|---:|
| 1.2 | 0.2559 | 0.2559 | 0.2547 | -33.876 | -34.537 | +11.56 |
| **AVG** | **0.2559** | **0.2559** | **0.2547** | **-33.876** | **-34.537** | **+11.56** |
