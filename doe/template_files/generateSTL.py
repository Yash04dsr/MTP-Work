...
R1 = D1 / 2.0
L_MAIN = 9.200       # main pipe length along Z
Z_JCT = 4.600        # junction centre along Z

D2 = 0.115           # branch pipe diameter [m]
R2 = D2 / 2.0
L_BRANCH = 1.380     # branch pipe length along +Y (top-of-pipe to branch inlet)

# ---------- Discretisation ---------------------------------------------
N_CIRC = 96          # circumferential divisions (used for BOTH pipes)
N_AXIAL_MAIN = 240   # axial divisions along main pipe
N_AXIAL_BRANCH = 48  # axial divisions along branch (above y = R1 ring)
